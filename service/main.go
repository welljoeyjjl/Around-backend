...
const (
	...
	DISTANCE        = "200km"
	ES_URL          = "http://35.237.1.23:9200"
	BUCKET_NAME     = "around-images"
...
func saveToBigTable(p *Post, id string) {
	...
	bt_client, err := bigtable.NewClient(ctx, "sodium-hour-225722", "around-post", option.WithCredentialsFile("Around-652e89719323.json"))
	if err != nil {
		panic(err)
		return
	}
